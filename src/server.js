...
// Import adapters
import { KaspaAdapter } from './infrastructure/kaspa/KaspaAdapter.js';
import { KasplexAdapter } from './infrastructure/kasplex/KasplexAdapter.js';

// Import services
import { CertificationService } from './application/services/CertificationService.js';

// Import API routes (we'll create these next)
import { createApiRouter } from './interfaces/api/routes.js';
...
async function startServer() {
  try {
    ...
    app.listen(PORT, () => {
      logger.info(`🚀 CertiKAS server running on port ${PORT}`);
